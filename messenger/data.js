var DATA = [
    {
      user: 'michael',
      message: 'Welcome to Coding club #coding',
      created_at: '2022-01-03 12:30:20',
    },
    {
      user: 'satya',
      message: 'this is test message #pair #programming',
      created_at: '2022-01-04 18:30:20',
    },
    {
      user: 'alien',
      message: 'code now! #work #hard',
      created_at: '2022-01-05 07:30:20',
    },
    {
      user: 'steve',
  ...
  var randomUser = ['michael', 'satya', 'alien', 'steve', 'tim', 'jeff'];
  var randomMessage = [
